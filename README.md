...
| `Not So Nice HTML Viewer` | Web | 🟡 Medium | Prototype Pollution, DOMPurify Misconfiguration |
| `Code Sandbox` | Web | 🟢 Easy | SSRF, Sandbox Escape `@nyariv/SandboxJS` |

## 2025
| Name | Competition | Category | Difficulty |
|------|-------------|----------|------------|
|      |             |          |            |
|      |             |          |            |
|      |             |          |            |
